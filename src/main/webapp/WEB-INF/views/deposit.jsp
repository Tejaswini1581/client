...
<center>	<h2 style="color:red;">${err}</h2></center>
  ...
  <f:form action="deposit1" modelAttribute="C">
            ...
            <table>
                ...
                <td><f:input path="amount" required="required" placeholder="Enter a number" onblur="return checkk();" /></td>
                 <td class="error"><f:errors path="amount"/></td>
            </tr>
  <tr> <th><label for="remarks">Remarks</label></th>
 	...
 	<link rel="stylesheet"
			href="${pageContext.request.contextPath}/styles/deposit.css">
    				 <script>
						function checkk() {
